...
gradientStroke1.addColorStop(0, 'rgba(255, 120, 0, 0.8)');
gradientStroke1.addColorStop(1, 'rgba(255, 120, 0, 0.2) ');
...
function index(myVarVal, myVarVal1) {
    ...
    gradientStroke.addColorStop(0, `rgba(${myVarVal}, 0.8)` || 'rgba(255, 120, 0, 0.8)');
    gradientStroke.addColorStop(1, `rgba(${myVarVal}, 0.2)` || 'rgba(255, 120, 0, 0.2) ');
