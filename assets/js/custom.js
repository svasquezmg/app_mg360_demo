(function () {
  ...
  /*new SimpleBar(myHeadernotification, { autoHide: true }); fmas*/

  var myHeadermessage = document.getElementById(
    "header-message-scroll"
  );
  /*new SimpleBar(myHeadermessage, { autoHide: true }); fmas*/

  var myHeaderCart = document.getElementById("header-cart-items-scroll");
    /*new SimpleBar(myHeaderCart, { autoHide: true });  fmas*/
  /* header dropdowns scroll */
  let typehead = document.querySelector("#typehead");
    /*typehead.addEventListener("click", showSearchResult); fmas*/
